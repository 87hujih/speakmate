import { ArrowRight, BriefcaseBusiness, MessageCircle, Utensils, UsersRound, type LucideIcon } from "lucide-react";
...
export function HistorySessionCard({ record }: HistorySessionCardProps) {
  ...
  return (
    <article className="flex items-center justify-between gap-5 rounded-panel border border-line bg-white p-5 shadow-soft">
